	...
	<div class="wrapper">
		...
		<div class="body">
			<div class="body-center-div">
				...
				<div class="table-wrapper">
					<table>
						...
						<tr>
							...
							<td><input id="displayName" type="text"
								value="${displayName}" placeholder="none" disabled></td>
						</tr>
				...
				<br /> <br />
				<div class="tc">
					<a id="allowEditButton" class="hoverHand">Edit Info</a> <br /> <br />
					<a id="deactiveButton" class="hoverHand">Deactivate Account</a>
				</div>
				<div id="accountLoading" class="tc loadingDiv"
					style="display: none;">
